...
final class OutboxStatus
{
     ...
     * @param DateTimeImmutable|null $claimExpiredSince When the claim that ran out first ran out (the retry time of its attempt): its relay died (or hangs), and no relay has taken it over since
    ...
    public function __construct(
        ...
        public readonly ?DateTimeImmutable $claimExpiredSince = null,
