...
final class OutboxStatus
{
     ...
     * @param int                    $retrying       Messages whose last attempt failed, neither published nor given up
     ...
     * @param DateTimeImmutable|null $oldestClaim    When the oldest unfinished claim was made (in flight, or interrupted because its relay died)
